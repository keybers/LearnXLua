...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CoustomCallInt))
			{
			    return new CoustomCallInt(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(CoustomCallMany))
			{
			    return new CoustomCallMany(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(CoustomCallMany1))
			{
			    return new CoustomCallMany1(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(CoustomCallChange))
			{
			    return new CoustomCallChange(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new System.Action<bool>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(CoustomCall))
			{
			    return new CoustomCall(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new System.Func<double, double, double>(__Gen_Delegate_Imp7);
			}
